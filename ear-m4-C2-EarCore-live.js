...
> 가칭 UMJIK(움직)은 자리표시자. 확정 시 전체 치환.
...
- **표준 파라미터 `exa`** (과장 계수, 1.0 = 물리적 사실): 모든 deform 코어의 필수 파라미터. "스타일 = 법칙 × 과장"의 시스템화. (표기 후보: `exa` 또는 `낙차` — 추후 결정)
